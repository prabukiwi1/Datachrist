public class MScAIMLOverloading {
    ...
    public MScAIMLOverloading(String val) {
    ...
    public MScAIMLOverloading(String val, int val2) {
        value = Integer.parseInt(val) + val2;
    }

    public MScAIMLOverloading(int val, double val2, int val3) {
        value = (int) (val * val2 + val3);
    }
    ...
    public static void main(String[] args) {
        ...
        MScAIMLOverloading obj4 = new MScAIMLOverloading("Invalid");
        obj4.printValue();
        ...
        MScAIMLOverloading obj9 = new MScAIMLOverloading("Java", 10);
        obj9.printValue();
